...
def run_mlserver_inference(pod_name: str, isvc: InferenceService, input_data: dict, model_version: str) -> Any:
    """
    Run inference against an MLServer model, handling both RAW and SERVERLESS deployments.
    For RAW, port-forwards to the pod and POSTs to localhost.
    For SERVERLESS, POSTs to the service URL.
    """
...
def validate_inference_request(
    ...
    response = run_mlserver_inference(pod_name, isvc, input_query, model_version)
