...
from tests.model_serving.model_runtime.openvino.constant import (
    ...
    TENSORFLOW_MODEL_FORMAT_NAME,
    OPENVINO_IR_MODEL_FORMAT_NAME,
)
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            ...
            get_deployment_config_dict(model_format_name=ONNX_MODEL_FORMAT_NAME, deployment_type=RAW_DEPLOYMENT_TYPE),
        ...
        pytest.param(
            REST_PROTOCOL_TYPE_DICT,
            get_model_namespace_dict(
                model_format_name=TENSORFLOW_MODEL_FORMAT_NAME,
                deployment_type=RAW_DEPLOYMENT_TYPE,
                protocol_type=Protocols.REST,
            ),
            get_deployment_config_dict(
                model_format_name=TENSORFLOW_MODEL_FORMAT_NAME, deployment_type=RAW_DEPLOYMENT_TYPE
            ),
            get_model_storage_uri_dict(model_format_name=TENSORFLOW_MODEL_FORMAT_NAME),
            get_deployment_config_dict(
                model_format_name=TENSORFLOW_MODEL_FORMAT_NAME, deployment_type=RAW_DEPLOYMENT_TYPE
            ),
            TENSORFLOW_MODEL_FORMAT_NAME,
        ...
        pytest.param(
            ...
            get_deployment_config_dict(
                model_format_name=TENSORFLOW_MODEL_FORMAT_NAME, deployment_type=SERVERLESS_DEPLOYMENT_TYPE
            ),
            get_model_storage_uri_dict(model_format_name=TENSORFLOW_MODEL_FORMAT_NAME),
            get_deployment_config_dict(
                model_format_name=TENSORFLOW_MODEL_FORMAT_NAME, deployment_type=SERVERLESS_DEPLOYMENT_TYPE
        ...
        pytest.param(
            REST_PROTOCOL_TYPE_DICT,
            get_model_namespace_dict(
                model_format_name=OPENVINO_IR_MODEL_FORMAT_NAME,
                deployment_type=RAW_DEPLOYMENT_TYPE,
                protocol_type=Protocols.REST,
            ),
            get_deployment_config_dict(
                model_format_name=OPENVINO_IR_MODEL_FORMAT_NAME, deployment_type=RAW_DEPLOYMENT_TYPE
            ),
            get_model_storage_uri_dict(model_format_name=OPENVINO_IR_MODEL_FORMAT_NAME),
            get_deployment_config_dict(
                model_format_name=OPENVINO_IR_MODEL_FORMAT_NAME, deployment_type=RAW_DEPLOYMENT_TYPE
            ),
            OPENVINO_IR_MODEL_FORMAT_NAME,
        ...
        pytest.param(
            ...
            get_deployment_config_dict(
                model_format_name=OPENVINO_IR_MODEL_FORMAT_NAME, deployment_type=SERVERLESS_DEPLOYMENT_TYPE
            ),
            get_model_storage_uri_dict(model_format_name=OPENVINO_IR_MODEL_FORMAT_NAME),
            get_deployment_config_dict(
                model_format_name=OPENVINO_IR_MODEL_FORMAT_NAME, deployment_type=SERVERLESS_DEPLOYMENT_TYPE
