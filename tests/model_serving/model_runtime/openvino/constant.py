...
TENSORFLOW_MODEL_FORMAT_NAME: str = "tensorflow"

OPENVINO_IR_MODEL_FORMAT_NAME: str = "openvino-ir"
...
ONNX_REST_INPUT_QUERY_PATH: str = str(OPENVINO_INPUT_BASE_PATH / "onnx_mnist_input.json")

TENSORFLOW_REST_INPUT_QUERY_PATH: str = str(OPENVINO_INPUT_BASE_PATH / "tensorflow_input.json")

OPENVINO_IR_REST_INPUT_QUERY_PATH: str = str(OPENVINO_INPUT_BASE_PATH / "openvino_ir_input.json")
