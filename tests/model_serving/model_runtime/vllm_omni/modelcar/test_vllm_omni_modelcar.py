...
class TestVllmOmniModelcar:
    def test_vllm_omni_modelcar_qwen3_tts_inference(
        ...
        assert len(response.content) > 44, "Response body too small; expected at least WAV header (44 bytes)"
        ...
        assert predictor_pods, "No predictor pods found for the InferenceService."
