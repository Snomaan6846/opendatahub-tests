...
class TestVllmOmniFLUX2ImageGeneration:
    ...
    Deploys FLUX.2-klein-4B on 2-GPU hardware and verifies that the
    ...
    def test_vllm_omni_flux2_image_generation(
        ...
        assert b64_json, "data[0].b64_json is empty or missing"
        ...
        assert not restarted, f"Pod containers restarted during FLUX.2 inference: {restarted}"
