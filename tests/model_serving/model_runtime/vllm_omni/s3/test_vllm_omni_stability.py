...
class TestVllmOmniQwen3TtsStabilityAndPerformance:
    ...
    def test_vllm_omni_tts_50_turn_session(
        ...
        Given a vLLM-Omni InferenceService with Qwen3-TTS loaded from S3 on 2x GPUs,
    ...
    def test_vllm_omni_tts_ttfb_and_e2e_latency(
        ...
        Given a vLLM-Omni InferenceService with Qwen3-TTS on 2x NVIDIA H100 80 GB GPUs,
...
class TestVllmOmniSoakComposite:
    ...
    def test_vllm_omni_composite_soak(
        ...
        Given a vLLM-Omni ISVC with Qwen3-TTS on 2x NVIDIA H100 80 GB GPUs and Prometheus
        ...
        soak_duration_s: int = int(os.environ.get("OMNI_SOAK_DURATION", "600"))
        base_url = vllm_omni_isvc_url
        ...
        assert ttfb_final <= SOAK_TTFB_DEGRADATION_RATIO * ttfb_min1, (
            ...
            f"Ratio: {ttfb_final / ttfb_min1:.3f}"
        )
        ...
        if baseline_gpu_usage is not None and baseline_gpu_usage > 0:
